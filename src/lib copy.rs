...
impl Vertex {
    fn desc() -> wgpu::VertexBufferLayout<'static> {
        print!("9999999999999999999--{}--", std::mem::size_of::<Vertex>());
...
impl<'a> State<'a> {
    async fn new(window: &'a Window, vertices1: &[Vertex], indices1: &[u16]) -> State<'a> {
        ...
        let num_indices = indices1.len() as u32;
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
...

        {
            ...
            print!("000==={}==000",self.vertex_buffer.size());
